...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public double __Gen_Delegate_Imp4(UnityEngine.Transform p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Func<UnityEngine.Transform, double>))
			{
			    return new System.Func<UnityEngine.Transform, double>(__Gen_Delegate_Imp4);
			}
