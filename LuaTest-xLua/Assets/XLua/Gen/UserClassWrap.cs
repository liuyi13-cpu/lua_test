...
namespace XLua.CSObjectWrap
{
    ...
    public class UserClassWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UserClass);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UserClass constructor!");
        ...
        static int _m_TestFunc1_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UserClass.TestFunc1( _num, _str, _pos, _trans );
